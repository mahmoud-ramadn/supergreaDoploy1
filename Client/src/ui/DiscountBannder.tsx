...
import {
    discountImgOne, discountImgTwo, brandOne,
    brandTwo ,brandThree,brandFour,brandFive,brandSix
 } from "../assets";


const DiscountBannder = () => {
...
export default DiscountBannder;
