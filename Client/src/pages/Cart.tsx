...
import CartProduct from "../ui/CatProduct";
          ...
          <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
              ...
              <dl className="mt-6 space-y-4">
                ...
                <dd className="text-sm font-medium text-gray-900">
                  <FormatCurranct amount={totalAmt.regular  }  />
                  </dd>
                </div>
                ...
                <dd className="text-sm font-medium text-gray-900">
                  <FormatCurranct amount={shippingAmt} />
                  </dd>
                </div>
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  ...
                  <FormatCurranct amount={totalAmt.regular - totalAmt.discounted} />
                  </dd>
                </div>
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  <dt className="text-base font-medium text-gray-900">
                  ...
                  <FormatCurranct amount={totalAmt?.discounted -shippingAmt +taxAmt} />
                  </dd>
                </div>
              </dl>
